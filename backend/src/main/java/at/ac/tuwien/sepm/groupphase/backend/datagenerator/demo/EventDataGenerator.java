...
public class EventDataGenerator implements DataGenerator{
    ...
    public void generate(){
        if(eventRepository.count() > 0){
            ...
            Event event2 = Event.builder().id(2L).name("MemoriesMade").durationInMinutes(180).eventType(EventType.MOVIE).artist(artistRepository.getOne(1L)).description("COMING SOON").content("content").build();
            ...
            Event event8 = Event.builder().id(8L).name("HouseParty").durationInMinutes(130).eventType(EventType.MUSICAL).artist(artistRepository.getOne(2L)).description("COMING SOON").content(null).build();
            ...
            Event event11 = Event.builder().id(11L).name("Galla Evening For Many").durationInMinutes(160).eventType(EventType.CONCERT).artist(artistRepository.getOne(3L)).description("COMING SOON").content(null).build();
            Event event12 = Event.builder().id(12L).name("Early Halloween").durationInMinutes(72).eventType(EventType.MUSICAL).artist(artistRepository.getOne(3L)).description("COMING SOON").content("content").build();
            ...
            Event event18 = Event.builder().id(18L).name("LetMeFixYa").durationInMinutes(120).eventType(EventType.MOVIE).artist(artistRepository.getOne(5L)).description("COMING SOON").content(null).build();
            ...
            Event event22 = Event.builder().id(22L).name("Bad Girls Play With Fire").durationInMinutes(240).eventType(EventType.OPERA).artist(artistRepository.getOne(8L)).description("COMING SOON").content("content").build();
            ...
            Event event28 = Event.builder().id(28L).name("Dirty Diana").durationInMinutes(180).eventType(EventType.MUSICAL).artist(artistRepository.getOne(11L)).description("COMING SOON").content(null).build();
            ...
            Event event31 = Event.builder().id(31L).name("Yoga for 1000 people").durationInMinutes(110).eventType(EventType.SPORT).artist(artistRepository.getOne(11L)).description("COMING SOON").content(null).build();
            Event event32 = Event.builder().id(32L).name("Cringe Party 2020").durationInMinutes(100).eventType(EventType.FESTIVAL).artist(artistRepository.getOne(12L)).description("COMING SOON").content("content").build();
